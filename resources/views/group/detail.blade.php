                                ...
                                <div class="flex items-start gap-2">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                            <span class="text-sm font-semibold text-gray-900 dark:text-white">{{ $post->comments()->latest()->first()->user->name }}</span>
                                            <span class="text-sm font-normal text-gray-500 dark:text-gray-400">{{ $post->comments()->latest()->first()->created_at->diffForHumans() }}</span>
                                        </div>
                                        <p class="py-2 text-sm font-normal text-gray-900 dark:text-white">{{ $post->comments()->latest()->first()->content }}</p>
                                    </div>
                                </div>
                                @endif
                            </div>
            ...
            $j(document).on('click', ".reply-button", function(e) {
                ...
                if ($j('#replyBox' + commentId).length === 0) {
                    var replyBox =
                        ...
                        commentId + '\', \'' + commentPrimaryId + '\')" class="px-3 py-2 text-white bg-blue-500 rounded-md" type="button">Post</button></div>';
