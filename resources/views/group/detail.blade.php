                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div>
                                <div class="flex justify-between w-11/12 mx-auto">
                                    <small class="cursor-pointer hover:underline"><span id="like_count_{{ $post->id }}">{{ $post->likes_count }}</span> likes</small>

                                    <button data-modal-target="comments-modal" data-post_id="{{ $post->id }}" data-modal-toggle="comments-modal" class="comment-list">
                                        <small class="cursor-pointer hover:underline"><span id="comment_count_{{ $post->id }}"> {{ $post->comments_count }}</span> comments</small>
                                    </button>
                                </div>
                            </div>
                            <div>
                                <div class="flex items-center gap-5 py-1 border-t border-b">
                                    <div class="w-1/2 text-center">
                                        <button class="like-post hover:bg-[#00000033] w-full py-3 rounded-md transition-colors" data-post_id="{{ $post->id }}">
                                            <i class="fa-regular fa-thumbs-up"></i>
                                            <span class="font-bold">Like</span></button>
                                    </div>
                                    <div class="w-1/2 text-center">
                                        <button class="create-comment-btn hover:bg-[#00000033] w-full py-3 rounded-md transition-colors"
    ...
    <div id="create-post-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md max-h-full p-4">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" method="POST" enctype="multipart/form-data" action="{{ route('web.save.post', $group->id) }}">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input name="post_media" class="text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
    ...
    <div id="create-comment-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md max-h-full p-4">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" method="POST" action="{{ route('web.comment.save') }}" enctype="multipart/form-data" id="comment-form">
                    @csrf
