    ...
    <div id="comment{{ $comment->id }}" data-comment_id="{{ $comment->id }}">
        <div class="flex items-start gap-2">
            ...
            <div
                ...
                <p class="py-2 text-sm font-normal text-gray-900 dark:text-white comment-text">{{ $comment->content }}
                </p>
            </div>
            <button
        ...
        <div class="flex flex-col gap-4 mt-5 replies">
            ...
            <div class="flex items-start justify-end gap-2 reply">
                <img class="w-8 h-8 rounded-full" src="http://localhost/medieor/public/img/no-avatar.png"
                    alt="Profile Picture">
                <div
                ...
                <div class="flex items-start justify-end gap-2 reply">
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-2 rtl:space-x-reverse">
                            ...
                            <span
                                class="text-sm font-normal text-gray-500 dark:text-gray-400">{{ $reply->created_at->diffForHumans() }}</span>
                        </div>
                    ...
                    @foreach ($comment->replies->slice(2) as $reply)
                        <div class="flex items-start justify-end gap-2 reply">
                            ...
                            <div
                                ...
                                <p class="py-2 text-sm font-normal text-gray-900 dark:text-white">{{ $reply->content }}
                                </p>
                            </div>
                            <button
                                class="inline-flex items-center self-center p-2 text-sm font-medium text-center text-gray-900 bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-gray-900 dark:hover:bg-gray-800 dark:focus:ring-gray-600 edit-button"
